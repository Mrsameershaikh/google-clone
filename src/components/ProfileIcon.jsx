    ...
    return (
        <div className="flex gap-2">
            ...
            <span className="h-10 w-10 relative flex justify-center items-center">
                <img src={ProfileRing} alt="profile-pic" className="absolute"/>
                <span className="h-8 w-8 rounded-full overflow-hidden">
                    <img className="h-full w-full object-cover" src="https://xsgames.co/randomusers/assets/avatars/male/16.jpg" />
                </span>
            </span>
        </div>
    );
